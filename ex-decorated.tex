...
\draw [<->, sloped, >=stealth, bend left, very thick] (b) to node [auto] {} (c);
\draw [<->, sloped, >=stealth, bend right, very thick] (d) to node [auto] {} (e);
\draw [<->, sloped, >=stealth, bend left, pos=0.3, very thick] (d) to node [auto] {} (f);
\draw [<->, sloped, >=stealth, bend right, pos=0.3, very thick] (d) to node [auto] {} (g);
\draw [<->, sloped, >=stealth, bend right, very thick] (e) to node [auto] {} (f);
\draw [<->, sloped, >=stealth, bend right, very thick] (e) to node [auto] {} (g);
\draw [<->, sloped, >=stealth, very thick] (f) to node [auto] {} (g);
\draw [<->, sloped, >=stealth, bend right, very thick] (h) to node [auto] {} (i);

\path (a) edge [loop above,->, >=stealth, very thick] node {}  (a);
\path (b) edge [loop above,->, >=stealth, very thick] node {}  (b);
\path (c) edge [loop above,->, >=stealth, very thick] node {}  (c);
\path (d) edge [loop above,->, >=stealth, very thick] node {}  (d);
\path (e) edge [loop above,->, >=stealth, very thick] node {}  (e);
\path (f) edge [loop above,->, >=stealth, very thick] node {}  (f);
\path (g) edge [->, >=stealth, very thick,out=50,in=20,looseness=6] node {}  (g);
\path (h) edge [loop below,->, >=stealth, very thick] node {}  (h);
\path (i) edge [loop below,->, >=stealth, very thick] node {}  (i);
...
\draw [->, sloped, >=stealth, very thick] (-0.5,-7) to node [auto] {\texttt{S}} (0.75,-7);
